...
describe("loadContentIndex", () => {
  it("indexes every fixture entry by canonical key", () => {
    ...
    expect([...index.entries.keys()].sort()).toEqual([
      ...
      "destiny/5",
      "dignity/jupiter/exaltation",
      "dignity/mars/domicile",
      "dignity/mercury/domicile",
      "dignity/moon/fall",
      "dignity/sun/domicile",
      "dignity/venus/domicile",
...
describe("resolveReading", () => {
  ...
  it("resolves the full section list in display order", () => {
    ...
    expect(reading.sections.map((s) => s.slot)).toEqual([
      ...
      "element",
      "modality",
      // The classical dignities the fixture placements carry (Sun–Jupiter;
      // Saturn in Pisces is neutral, the moderns have none).
      "dignity",
      "dignity",
      "dignity",
      "dignity",
