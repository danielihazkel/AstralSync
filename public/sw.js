 ...
 *
 * Bumping VERSION is the entire update story: the registration uses
 * updateViaCache "none" and /sw.js is served with no-store, so a new version
 * installs on the next load and activate() drops every old cache.
 */
